  ...
  void _getData() {
    _productData = [
      ...
      ProductModel(
          ...
          price: 2.5,
          image: "${GlobalUrl}images/product/34.jpg",
          rating: 5,
          review: 302,
          sale: 752,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 3,
          image: "${GlobalUrl}images/product/35.jpg",
          rating: 5,
          review: 636,
          sale: 2087,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 10.6,
          image: "${GlobalUrl}images/product/36.jpg",
          rating: 5,
          review: 2802,
          sale: 7052,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 19.9,
          image: "${GlobalUrl}images/product/37.jpg",
          rating: 5,
          review: 105,
          sale: 227,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 2.33,
          image: "${GlobalUrl}images/product/38.jpg",
          rating: 5,
          review: 503,
          sale: 3645,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 5.3,
          image: "${GlobalUrl}images/product/39.jpg",
          rating: 5,
          review: 1095,
          sale: 3400,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 10,
          image: "${GlobalUrl}images/product/40.jpg",
          rating: 5,
          review: 63,
          sale: 131,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 48,
          image: "${GlobalUrl}images/product/41.jpg",
          rating: 5,
          review: 182,
          sale: 427,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 22.66,
          image: "${GlobalUrl}images/product/42.jpg",
          rating: 5,
          review: 131,
          sale: 466,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 2212,
          image: "${GlobalUrl}images/product/43.jpg",
          rating: 5,
          review: 16,
          sale: 37,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 1643,
          image: "${GlobalUrl}images/product/44.jpg",
          rating: 5,
          review: 2,
          sale: 3,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 9,
          image: "${GlobalUrl}images/product/45.jpg",
          rating: 5,
          review: 30,
          sale: 70,
          location: "Brooklyn"),
