...
import '../../../models/screens/category_model.dart';
import '../../../models/screens/product_model.dart';
...
class _Home3PageState extends State<Home3Page> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _bannerData.add(BannerSliderModel(
        id: 5, image: '${GlobalUrl}images/home_banner/5.jpg'));
    _bannerData.add(BannerSliderModel(
        id: 4, image: '${GlobalUrl}images/home_banner/4.jpg'));
    _bannerData.add(BannerSliderModel(
        id: 1, image: '${GlobalUrl}images/home_banner/1.jpg'));
    _bannerData.add(BannerSliderModel(
        id: 2, image: '${GlobalUrl}images/home_banner/2.jpg'));
    _bannerData.add(BannerSliderModel(
        id: 3, image: '${GlobalUrl}images/home_banner/3.jpg'));

    _categoryData.add(CategoryModel(
        id: 1,
        name: 'Fashion',
        image: '${GlobalUrl}images/category/fashion.png'));
    _categoryData.add(CategoryModel(
        id: 2,
        name: 'Smartphone & Tablets',
        image: '${GlobalUrl}images/category/smartphone.png'));
    _categoryData.add(CategoryModel(
        id: 3,
        name: 'Electronic',
        image: '${GlobalUrl}images/category/electronic.png'));
    _categoryData.add(CategoryModel(
        id: 4,
        name: 'Otomotif',
        image: '${GlobalUrl}images/category/otomotif.png'));
    _categoryData.add(CategoryModel(
        id: 5, name: 'Sport', image: '${GlobalUrl}images/category/sport.png'));
    _categoryData.add(CategoryModel(
        id: 6, name: 'Food', image: '${GlobalUrl}images/category/food.png'));
    _categoryData.add(CategoryModel(
        id: 7,
        name: 'Voucher\nGame',
        image: '${GlobalUrl}images/category/voucher_game.png'));
    _categoryData.add(CategoryModel(
        id: 8,
        name: 'Health & Care',
        image: '${GlobalUrl}images/category/health.png'));
    _categoryData.add(CategoryModel(
        id: 9, name: 'Food', image: '${GlobalUrl}images/category/food.png'));
    _categoryData.add(CategoryModel(
        id: 10,
        name: 'Electronic',
        image: '${GlobalUrl}images/category/electronic.png'));
    _categoryData.add(CategoryModel(
        ...
        image: '${GlobalUrl}images/category/fashion.png'));
    _categoryData.add(CategoryModel(
        id: 12, name: 'Sport', image: '${GlobalUrl}images/category/sport.png'));
    _categoryData.add(CategoryModel(
        id: 13,
        name: 'Voucher\nGame',
        image: '${GlobalUrl}images/category/voucher_game.png'));
    ...
    _productData = [
      ProductModel(
          ...
          price: 18.3,
          image: "${GlobalUrl}images/product/25.jpg",
          rating: 5,
          review: 212,
          sale: 735,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 567,
          image: "${GlobalUrl}images/product/26.jpg",
          rating: 5,
          review: 63,
          sale: 115,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 52,
          image: "${GlobalUrl}images/product/27.jpg",
          rating: 5,
          review: 7,
          sale: 7,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 261,
          image: "${GlobalUrl}images/product/29.jpg",
          rating: 5,
          review: 98,
          sale: 263,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 751,
          image: "${GlobalUrl}images/product/30.jpg",
          rating: 5,
          review: 14,
          sale: 17,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 224.14,
          image: "${GlobalUrl}images/product/31.jpg",
          rating: 5,
          review: 701,
          sale: 1558,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 28.67,
          image: "${GlobalUrl}images/product/32.jpg",
          rating: 5,
          review: 146,
          sale: 398,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 139,
          image: "${GlobalUrl}images/product/33.jpg",
          rating: 5,
          review: 275,
          sale: 1055,
          location: "Brooklyn")
    ...
    _trendingData = [
      ProductModel(
        id: 1,
        name: "Adidas Shirt",
        image: "${GlobalUrl}images/product/21.jpg",
        sale: 12700,
      ),
      ProductModel(
        id: 2,
        name: "iPhone SE 2020",
        image: "${GlobalUrl}images/product/22.jpg",
        sale: 8300,
      ),
      ProductModel(
        id: 3,
        name: "Macbook Air 2020",
        image: "${GlobalUrl}images/product/23.jpg",
        sale: 31400,
      ),
      ProductModel(
        id: 4,
        name: "Gaming Chair",
        image: "${GlobalUrl}images/product/24.jpg",
        sale: 11900,
      )
    ];
                ...
                child: ConstrainedBox(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          child: Text(_trendingData[index].name,
                              style: TextStyle(
                        ...
                        Expanded(
                          child: Text(
                              _trendingData[index].sale.toString() + ' product',
