...
class _NavPage1State extends State<NavPage1> {
  ...
  void initState() {
    ...
    _movieData.add(BannerSliderModel(
        id: 1,
        name: 'Bloodshot',
        image: '${GlobalUrl}images/movie/bloodshot.jpg'));
    _movieData.add(BannerSliderModel(
        id: 2,
        name: 'Dolittle',
        image: '${GlobalUrl}images/movie/dolittle.jpg'));
    _movieData.add(BannerSliderModel(
        id: 3,
        name: 'The Invisible Man',
        image: '${GlobalUrl}images/movie/invisible_man.jpg'));
    _movieData.add(BannerSliderModel(
        id: 4,
        name: 'Peninsula',
        image: '${GlobalUrl}images/movie/peninsula.jpg'));
    _movieData.add(BannerSliderModel(
        id: 5,
        name: 'Train to Busan',
        image: '${GlobalUrl}images/movie/train_to_busan.jpg'));
    _movieData.add(BannerSliderModel(
        id: 6, name: 'Venom', image: '${GlobalUrl}images/movie/venom.jpg'));
    _movieData.add(BannerSliderModel(
        id: 7, name: '#Alive', image: '${GlobalUrl}images/movie/alive.jpg'));
    _movieData.add(BannerSliderModel(
        id: 8,
        name: 'Avengers: Endgame',
        image: '${GlobalUrl}images/movie/avenger.jpg'));
