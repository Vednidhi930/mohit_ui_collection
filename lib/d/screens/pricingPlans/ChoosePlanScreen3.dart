...
class ChoosePlanScreen3State extends State<ChoosePlanScreen3> {
  ...
  Future<void> init() async {
    planList.add(
      PlanModal(
        image: '${GlobalUrl}images/pricingPlans/ThirdScreen1.png',
        title: 'Basic',
    ...
    planList.add(
      PlanModal(
        image: '${GlobalUrl}images/pricingPlans/ThirdScreen2.png',
        title: 'Standard',
    ...
    planList.add(
      PlanModal(
        image: '${GlobalUrl}images/pricingPlans/ThirdScreen3.png',
        title: 'Enterprise',
