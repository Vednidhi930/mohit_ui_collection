              ...
              Row(
                children: [
                  ...
                  Icon(Icons.keyboard_arrow_down,
                      color: customLightGreyColor, size: 20),
                ],
              ),
            ],
          ),
        ...
        ScrollConfiguration(
          ...
          child: HorizontalList(
            ...
            itemBuilder: (context, index) {
              SplitBillInfoModel nearbyFriendData =
                  splitNearbyFriendsInfo[index];
              return Container(
                ...
                decoration: BoxDecoration(
                  color: appStore.isDarkModeOn
                      ...
                      : primarySplitBillColor.withOpacity(0.5),
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                          ...
                          color: nearbyFriendData.iconBgColor),
                      padding: EdgeInsets.all(8),
                      child: commonCachedNetworkImage(nearbyFriendData.icon!,
          ...
          child: Column(
            ...
            children: [
              ...
              ...List.generate(
                5,
                (index) {
                  SplitBillInfoModel recentSplitData =
                      recentSplitInfo[index % recentSplitInfo.length];
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text('${recentSplitData.recentSplitTitle}',
                          style: boldTextStyle()),
                      subtitle: RichText(
                        text: TextSpan(
                          text: 'Total payment ',
                          ...
                          children: [
                            TextSpan(
                                text:
                                    '\$${recentSplitData.recentSplitSubTitleAmount}',
                                style: secondaryTextStyle(size: 12)),
                          ],
                        ),
                      ),
                      leading: Container(
                        ...
                        child: commonCachedNetworkImage(ic_group,
                            height: 24,
                            width: 24,
                      ...
                      trailing: Stack(
                        ...
                        children:
                            List.generate(recentSplitIconInfo.length, (index) {
                          SplitBillInfoModel recentSplitIconData =
                              recentSplitIconInfo[index];
                          return Container(
                            margin: EdgeInsets.only(left: (index * 18)),
                            padding: EdgeInsets.all(8),
                            decoration: BoxDecoration(
                                color: recentSplitIconData.iconBgColor,
                                shape: BoxShape.circle),
                            child: commonCachedNetworkImage(
                                recentSplitIconData.recentSplitTrailingIcon!,
                                height: 22,
                                width: 22),
                          );
                        }),
