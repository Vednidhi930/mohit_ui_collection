          ...
          Padding(
            ...
            child: ListTile(
              ...
              leading: Padding(
                ...
                child: commonCachedNetworkImage(widget.icon!,
                    height: 35, width: 35),
              ),
              trailing: Container(
                height: 40,
                ...
                decoration: BoxDecoration(
                    color: dividerBankingColor, borderRadius: radius(20)),
                child: IconButton(
                ...
                ListTile(
                  ...
                  trailing: Container(
                    ...
                    child: Text(
                      '${widget.amount}',
                      style: boldTextStyle(
                          color: widget.isNegativeSign!
                              ? null
                              : primaryBankingColor2),
                    ),
                  ),
                ),
                Row(
                  children: [
                    commonCachedNetworkImage(ic_attachment,
                        height: 20,
                        width: 20,
                        color: appStore.isDarkModeOn
                            ? Colors.white
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      10.height,
                      Text('Are you having a problem with this transaction?',
