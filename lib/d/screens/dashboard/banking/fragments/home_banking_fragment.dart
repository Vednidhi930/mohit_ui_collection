        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
                  ...
                  children: [
                          ...
                          children: List.generate(icons.length, (index) {
                            return Container(
                              ...
                              child: IconButton(
                                ...
                                icon: commonCachedNetworkImage(icons[index],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('2432.57',
                            style: boldTextStyle(color: whiteColor, size: 26)),
                      ],
                    ),
                  ],
                ),
              ...
              Padding(
                padding:
                    EdgeInsets.only(left: 16, right: 16, bottom: 16, top: 20),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
                      ...
                      children: [
                        Expanded(
                            flex: 2,
                            child:
                                Text('Recent', style: boldTextStyle(size: 18))),
                        TextButton(
                          onPressed: () {
                            //
                          },
                          child: Row(
                            children: [
                              Text('Show all',
                                  style: boldTextStyle(
                                      color: primaryBankingColor1, size: 14)),
                              SizedBox(width: 8),
                              Icon(Icons.arrow_forward_ios_sharp,
                                  color: primaryBankingColor1, size: 12),
                            ],
                          ),
                        ),
                      ],
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          BankingInfoModel lastWeekData =
                              setLastWeekDetail[index];
                          bool isNegativeSign =
                              lastWeekData.lastWeekAmount!.contains('-') ==
                                  true;
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          BankingInfoModel lastMonthData =
                              setLastMonthDetail[index];
                          bool isNegativeSign =
                              lastMonthData.lastWeekAmount!.contains('-') ==
                                  true;
