...
import '../../../../../main/AppWidget.dart' hide boxDecoration;

import '../../banking/utils/images.dart';
import '../components/articles_component.dart';
import '../components/doctor_info_component.dart';
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Align(
                          ...
                          child: commonCachedNetworkImage(ic_menu,
                              height: 32,
                              width: 32,
                      ...
                      Expanded(
                          flex: 2,
                          child: commonCachedNetworkImage(img_woman,
                              height: 60, width: 60)),
                      SizedBox(
                        height: 60,
                        child: Stack(
                          children: [
                            Align(
                              ...
                              child: Row(
                                ...
                                children: [
                                  commonCachedNetworkImage(ic_chat,
                                      height: 32,
                                      width: 32,
                                      color: appStore.isDarkModeOn
                                          ? Colors.white
                                          : Colors.black),
                                  20.width,
                                  commonCachedNetworkImage(ic_notification,
                                      height: 32,
                                      width: 32,
                                      color: appStore.isDarkModeOn
                                          ? Colors.white
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        commonCachedNetworkImage(ic_search,
                            height: 22,
                            width: 22,
                            color: appStore.isDarkModeOn
                                ? Colors.white
                                : Colors.black),
                        10.width,
                        Text('Search Doctors, Health Issues',
                  ...
                  Wrap(
                    ...
                    children: List.generate(setDoctorInfoList.length, (index) {
                      DoctorDashboardInfoModel doctorData =
                          setDoctorInfoList[index];
                    ...
                    children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text('${doctorData.docName}',
                                                style: boldTextStyle(size: 20)),
                                            10.height,
                                            Text('${doctorData.docCourse}',
                                                style: secondaryTextStyle()),
                                          ],
                                        ),
                                      ],
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: primaryHealthMedicalColor
                                          .withOpacity(0.1),
                                      borderRadius: radiusOnly(
                                          bottomLeft: DEFAULT_CONTAINER_RADIUS,
                                          bottomRight:
                                              DEFAULT_CONTAINER_RADIUS),
                                    ),
                                    child: Row(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            commonCachedNetworkImage(ic_clock,
                                                height: 16,
                                                width: 16,
                                                color:
                                                    primaryHealthMedicalColor),
                                            5.width,
                                            Text('${doctorData.docTime}',
                                                style: primaryTextStyle(
                                                    color:
                                                        primaryHealthMedicalColor)),
                                          ],
                      ...
                      RotatedBox(
                        ...
                        child: DottedBorderWidget(
                          ...
                          color: appStore.isDarkModeOn
                              ? dividerMedicalDarkColor
                              : Colors.black,
                          padding: EdgeInsets.all(8),
                          child: Text('Make A New',
                              style: primaryTextStyle(),
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      DoctorDashboardInfoModel articlesData =
                          setArticlesList[i];
