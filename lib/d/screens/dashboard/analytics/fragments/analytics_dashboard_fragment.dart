...
import '../../health_medical/utils/images.dart';
import '../components/last_seen_drop_down_component.dart';
import '../components/page_analytics_list_component.dart';
import '../components/page_drop_down_component.dart';
import '../components/spline_chart_component.dart';
...
class AnalyticsDashboardFragment extends StatefulWidget {
  ...
  @override
  _AnalyticsDashboardFragmentState createState() =>
      _AnalyticsDashboardFragmentState();
}

class _AnalyticsDashboardFragmentState
    extends State<AnalyticsDashboardFragment> {
      ...
      appBar: appBarWidget(
        ...
        actions: [
          IconButton(
            ...
            icon: commonCachedNetworkImage(ic_search,
                height: 20,
                width: 20,
          ...
          IconButton(
            ...
            icon: commonCachedNetworkImage(ic_notification,
                height: 20,
                width: 20,
                color: appStore.isDarkModeOn ? Colors.white : Colors.black),
          ),
          IconButton(
            ...
            icon: ClipRRect(
                borderRadius: BorderRadius.circular(DEFAULT_ANALYTICS_RADIUS),
                child: commonCachedNetworkImage(img_person,
        ...
        systemUiOverlayStyle: SystemUiOverlayStyle(
            statusBarColor:
                appStore.isDarkModeOn ? appBackgroundColorDark : Colors.white),
      ),
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: commonCachedNetworkImage(ic_revenue,
                        height: 22,
                        width: 22,
                        color: appStore.isDarkModeOn
                            ? Colors.white
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('${revenueData.analyticsTitle}'.toUpperCase(),
                      ...
                      richText(
                        ...
                        text2:
                            '${isNegative ? "\u2193" : "\u2191"} ${revenueData.analyticsPercentage}',
                  ...
                  Container(
                    ...
                    child: TextIcon(
                      ...
                      suffix: commonCachedNetworkImage(ic_details,
                          height: 15,
                          width: 15,
                          color: appStore.isDarkModeOn
                              ? textSecondaryColor
            ...
            Wrap(
              ...
              children: List.generate(setPageAnalyticsInfo.length, (index) {
                AnalyticsInfoModel pageAnalyticData =
                    setPageAnalyticsInfo[index];
                return Container(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('${monthOfVisitorsData.visitorsMonth} visitors',
