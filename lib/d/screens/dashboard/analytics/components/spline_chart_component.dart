  ...
  void init() async {
    for (int i = 1; i <= 30; i++) {
      chartData.add(ChartDataModel(
          dateMonthYear: i + 10,
          visitors: Random().nextInt(16000000).toDouble()));
    }
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return SfCartesianChart(
      ...
      primaryYAxis: NumericAxis(
          axisLine: AxisLine(width: 0), numberFormat: NumberFormat.compact()),
      ...
      trackballBehavior: TrackballBehavior(
          enable: true, tooltipSettings: InteractiveTooltip(enable: true)),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  6.height,
                  Text('${data.dateMonthYear} Nov 2022',
