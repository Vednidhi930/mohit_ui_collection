...
import '../component/usage_history_component.dart';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          icon: commonCachedNetworkImage(ic_home_setting,
                              height: 20,
                              width: 20,
                              color: appStore.isDarkModeOn
                                  ? Colors.white
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            8.width,
                            commonCachedNetworkImage(ic_rainy_day,
                                color: appStore.isDarkModeOn
                                    ? Colors.white
                                    : Colors.black,
                                height: 20,
                  ...
                  Wrap(
                    children:
                        List.generate(setUsageHistoryDetail.length, (index) {
                      SmartHomeInfoModel usageHistoryData =
                          setUsageHistoryDetail[index];
                      return UsageHistoryComponent(
