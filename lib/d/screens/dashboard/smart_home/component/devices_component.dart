  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        title: Text('${widget.deviceData.deviceTitle}',
        ...
        subtitle: RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(
                  text: '${widget.deviceData.deviceStatus}',
        ...
        leading: Container(
          ...
          decoration: BoxDecoration(
              color: widget.deviceData.deviceIconColor!.withOpacity(0.3),
              shape: BoxShape.circle),
          child: commonCachedNetworkImage(widget.deviceData.deviceIcon!,
              height: 22, width: 22, color: widget.deviceData.deviceIconColor),
        ),
