        ...
        child: PageView(
          ...
          children: <Widget>[
            Stack(
              ...
              children: <Widget>[
                commonCacheImageWidget(t14_travel2, height,
                                    ...
                                    children: [
                                      WidgetSpan(
                                        child: Padding(
                                          ...
                                          child: SvgPicture.network(t13_ic_map,
                                    ...
                                    children: [
                                      WidgetSpan(
                                        child: Padding(
                                          padding: EdgeInsets.only(
                                              right: spacing_control),
                                          child: SvgPicture.network(t13_ic_home,
                                              color: t13_textColorSecondary,
                                              width: 18,
                                              height: 18),
                                        ),
                          ...
                          children: [
                            WidgetSpan(
                              child: Padding(
                                padding:
                                    EdgeInsets.only(right: spacing_control),
                                child: SvgPicture.network(t13_ic_bath,
                                    color: t13_textColorSecondary,
                                    width: 18,
                                    height: 18),
                              ),
                          ...
                          children: [
                            WidgetSpan(
                              child: Padding(
                                padding:
                                    EdgeInsets.only(right: spacing_control),
                                child: SvgPicture.network(t13_ic_bed,
                                    color: t13_textColorSecondary,
                                    width: 18,
                                    height: 18),
                              ),
