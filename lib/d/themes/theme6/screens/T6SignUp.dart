...
import '../utils/T6CalendarStrip.dart';
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  alignment: Alignment.center,
                  child:
                      commonCachedNetworkImage(t6_ic_logo, width: width / 2.2),
                ),
                SizedBox(height: 30),
                ...
                Row(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: SvgPicture.network(t6_google_fill,
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.all(width / 28),
                      child:
                          SvgPicture.network(t6_facebook_fill, color: t6white),
                    ),
                  ],
                )
              ],
