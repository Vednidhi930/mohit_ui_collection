                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Padding(
                          ...
                          child: SvgPicture.network(t8_ic_facebook,
                              color: t8_white),
                        )),
                    Container(
                        margin: EdgeInsets.only(left: 16, bottom: 20),
                        ...
                        child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child:
                              SvgPicture.network(t8_ic_google, color: t8_white),
                        )),
                    Container(
                        margin: EdgeInsets.only(left: 16, bottom: 20),
                        width: context.width() * 0.15,
                        ...
                        child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child:
                              SvgPicture.network(t8_ic_mail, color: t8_white),
                        )),
                    Container(
                        margin:
                        ...
                        child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: SvgPicture.network(t8_ic_twitter,
                              color: t8_white),
                        )),
                  ],
                ),
...
Widget t8ResultOption(var icon, var color) {
  return Container(
      ...
      child: Padding(
        padding: EdgeInsets.all(10.0),
        child: SvgPicture.network(icon, color: t8_white),
      ));
}
