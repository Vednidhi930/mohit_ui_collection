              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                      ...
                      children: <Widget>[]),
                  commonCachedNetworkImage(t1_walk_bottom,
  ...
  switch (currentPage) {
    case 0:
      Container(
          ...
          child: commonCachedNetworkImage(t1_walk_top,
              width: 40, height: 40, alignment: Alignment.topRight));
      break;
    case 1:
      commonCachedNetworkImage(t1_walk_top, width: 40, height: 40);
      break;
    case 2:
      Container(
          margin: new EdgeInsets.fromLTRB(30, 0, 0, 0),
          child: commonCachedNetworkImage(t1_walk_top, width: 40, height: 40));
      break;
  }
}
