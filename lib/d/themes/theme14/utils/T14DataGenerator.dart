...
import 'T14Images.dart';
import 'T14Strings.dart';
...
List<SubscriptionModel> getTopTravelList() {
  ...
  topTravelList
      .add(SubscriptionModel(name: 'Keoladeo National Park', img: t14_travel1));
  topTravelList.add(SubscriptionModel(name: 'Easter Island', img: t14_travel2));
  topTravelList
      .add(SubscriptionModel(name: 'Machu Picchu, Peru', img: t14_travel3));
  topTravelList.add(SubscriptionModel(name: 'Petra, Jordan', img: t14_travel1));
  topTravelList
      .add(SubscriptionModel(name: 'Stonehenge, England', img: t14_travel2));
...
List<SubscriptionModel> getRecommendList() {
  ...
  recommendList.add(
    SubscriptionModel(name: 'England', img: t14_travel1),
  );
  recommendList.add(
    SubscriptionModel(name: 'Cambodia', img: t14_travel2),
  );
  recommendList.add(
    SubscriptionModel(name: 'Ukraine', img: t14_travel3),
  );
  recommendList.add(
    SubscriptionModel(name: 'USA', img: t14_travel1),
  );
  recommendList.add(
    SubscriptionModel(name: 'Island', img: t14_travel2),
  );
  recommendList.add(
    SubscriptionModel(name: 'Peru', img: t14_travel3),
  );
  recommendList.add(
    SubscriptionModel(name: 'Jordan', img: t14_travel1),
  );
  recommendList.add(
    SubscriptionModel(name: 'Tokyo', img: t14_travel2),
  );
...
List<SubscriptionModel> getTravelStoryDetailList() {
  ...
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel2, name: 'Edwards Roberts', userImg: t14_profile4));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel3, name: 'David Steward', userImg: t14_profile2));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel1, name: 'Jenkins Lawrence', userImg: t14_profile3));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel2, name: 'Lawrence Jones', userImg: t14_profile1));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel3, name: 'Graham Murphy', userImg: t14_profile4));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel1, name: 'Burton Armstrong', userImg: t14_profile1));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel2, name: 'Cole Walsh', userImg: t14_profile2));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel3, name: 'Carter Yates', userImg: t14_profile3));
...
List<SubscriptionModel> getMostPopularList() {
  ...
  mostPopular.add(
    SubscriptionModel(
        country: 'USA', img: t14_travel1, name: 'Keoladeo National Park'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Island', img: t14_travel2, name: 'Easter Island'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Peru', img: t14_travel3, name: 'Machu Picchu, Peru'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Jordan', img: t14_travel1, name: 'Petra, Jordan'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Tokyo', img: t14_travel2, name: 'Stonehenge, England'),
  );
