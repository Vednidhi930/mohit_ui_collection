    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: GestureDetector(
          ...
          child: Icon(Icons.arrow_back, color: appStore.iconColor),
        ),
        title: Row(
          children: <Widget>[
            ...
            8.width,
            Text(widget.name!,
                style: TextStyle(color: appStore.iconColor, fontSize: 16)),
          ],
        ),
        actions: [
          Padding(
              padding: EdgeInsets.only(right: 16),
              child: Icon(Icons.call, color: appStore.iconColor, size: 20))
        ],
      ),
      body: Stack(
        children: [
