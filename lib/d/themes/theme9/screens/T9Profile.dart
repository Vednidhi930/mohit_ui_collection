                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            t9Award(t9_ic_achievements, t9_colorPrimary),
                            t9Award(t9_ic_achievements, t9_green),
                            t9Award(t9_ic_achievements, t9_light_pink),
                            t9Award(t9_ic_achievements, t9_orange_dark),
                          ],
                        )
                      ],
                    )
