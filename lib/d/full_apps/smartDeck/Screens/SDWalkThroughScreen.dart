                ...
                Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Image(
                        image: AssetImage(
                            '${GlobalUrl}images/smartDeck/images/sduser.png'),
                ...
                Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Image(
                        image: AssetImage(
                            '${GlobalUrl}images/smartDeck/images/sdreport.png'),
                        height: size.height * 0.3,
                        width: size.width,
                        fit: BoxFit.contain,
                      ),
                ...
                Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Image(
                        image: AssetImage(
                            '${GlobalUrl}images/smartDeck/images/sdclip.png'),
                        height: size.height * 0.3,
                        width: size.width,
                        fit: BoxFit.contain,
                      ),
