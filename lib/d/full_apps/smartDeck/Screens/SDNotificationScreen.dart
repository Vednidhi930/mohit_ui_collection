...
import '../ModelClass/SDNotidicationModel.dart';
...
class _SDNotificationScreenState extends State<SDNotificationScreen> {
  List<SDNotidicationModel> notification = [
    ...
    SDNotidicationModel(
      images: '${GlobalUrl}images/smartDeck/images/sdsuccess.png',
      notificationmessage: 'Buy ₹50 Credit success',
      time: '2 min ago',
      dot: true,
    ),
    SDNotidicationModel(
      images: '${GlobalUrl}images/smartDeck/images/sdupdate.png',
    ...
    SDNotidicationModel(
      images: '${GlobalUrl}images/smartDeck/images/sdwarning.png',
    ...
    SDNotidicationModel(
      images: '${GlobalUrl}images/smartDeck/images/sdbell.png',
