...
import 'package:mohit_ui_collection/d/full_apps/shopHop/utils/ShExtension.dart';
...
import '../models/ShProduct.dart';
import '../screens/ShCartScreen.dart';
import '../screens/ShProductDetail.dart';
...
Widget networkImage(String image,
  ...
  return commonCachedNetworkImage(image,
      width: aWidth, height: aHeight, fit: BoxFit.fill);
}
...
Widget shareIcon(String iconPath) {
  return Padding(
    ...
    child: commonCachedNetworkImage(iconPath,
    ...
    child: Stack(
      ...
      children: <Widget>[
        Container(
          ...
          child: SvgPicture.network(sh_ic_cart,
