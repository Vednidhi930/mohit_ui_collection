...
import 'ShAccountScreen.dart';
import 'ShCartFragment.dart';
import 'ShContactUsScreen.dart';
import 'ShFAQScreen.dart';
import 'ShHomeFragment.dart';
import 'ShOrderListScreen.dart';
import 'ShProfileFragment.dart';
import 'ShSearchScreen.dart';
import 'ShSettingsScreen.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: Stack(
              ...
              children: <Widget>[
                commonCachedNetworkImage(bg_bottom_bar,
                    width: width,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        commonCachedNetworkImage(ic_app_icon, width: 40),
                        Row(
