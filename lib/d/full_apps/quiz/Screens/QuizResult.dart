                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Padding(
                          ...
                          child: SvgPicture.network(quiz_ic_facebook,
                              color: quiz_white)),
                    ).onTap(() {
                    ...
                    Container(
                      ...
                      child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: SvgPicture.network(quiz_ic_google,
                              color: quiz_white)),
                    ).onTap(() {
                    ...
                    Container(
                      ...
                      child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: SvgPicture.network(quiz_ic_mail,
                              color: quiz_white)),
                    ).onTap(() {
                    ...
                    Container(
                      ...
                      child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: SvgPicture.network(quiz_ic_twitter,
                              color: quiz_white)),
                    ).onTap(() {
