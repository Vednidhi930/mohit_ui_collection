...
import 'package:mohit_ui_collection/d/full_apps/grocery/model/GroceryModel.dart';
...
List<NotificationModel> notificationItem() {
  ...
  mList.add(NotificationModel("HouseHold", "now", Mohit_UI_KitShortText));
  mList.add(NotificationModel("Grocery", "4 min ago", Mohit_UI_KitShortText));
  mList.add(NotificationModel("Chilled", "30 min ago", Mohit_UI_KitShortText));
  return mList;
}
