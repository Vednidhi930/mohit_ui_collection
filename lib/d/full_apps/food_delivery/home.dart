...
import 'package:mohit_ui_collection/d/full_apps/food_delivery/restaurant_list.dart';
import 'package:mohit_ui_collection/d/full_apps/food_delivery/search_restaurant.dart';
import 'package:mohit_ui_collection/d/full_apps/food_delivery/user_profile.dart';
...
import '../../../models/feature/category_model.dart';
import '../../../models/apps/food_delivery/food_model.dart';
import '../../../models/apps/food_delivery/restaurant_model.dart';
import '../../../models/screens/banner_slider_model.dart';
import '../../screens/reusable/global_function.dart';
import '../../screens/reusable/shimmer_loading.dart';
import '../food_delivery/reusable_widget.dart';
import '../food_delivery/coupon.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void _getData() {
    ...
    _bannerData.add(BannerSliderModel(
        id: 1,
        image: '${GlobalUrl}images/apps/food_delivery/home_banner/1.jpg'));
    _bannerData.add(BannerSliderModel(
        id: 2,
        image: '${GlobalUrl}images/apps/food_delivery/home_banner/2.jpg'));
    _bannerData.add(BannerSliderModel(
        id: 3,
        image: '${GlobalUrl}images/apps/food_delivery/home_banner/3.jpg'));
    _bannerData.add(BannerSliderModel(
        id: 4,
        image: '${GlobalUrl}images/apps/food_delivery/home_banner/4.jpg'));
    ...
    _categoryData.add(CategoryModel(
        id: 1,
        name: 'Nearby',
        image: '${GlobalUrl}images/apps/food_delivery/category/nearby.png'));
    _categoryData.add(CategoryModel(
        id: 2,
        name: 'Western Food',
        image: '${GlobalUrl}images/apps/food_delivery/category/western.png'));
    _categoryData.add(CategoryModel(
        id: 3,
        name: 'Eastern Food',
        image: '${GlobalUrl}images/apps/food_delivery/category/eastern.png'));
    _categoryData.add(CategoryModel(
        id: 4,
        name: 'Healthy Food',
        image: '${GlobalUrl}images/apps/food_delivery/category/health.png'));
    _categoryData.add(CategoryModel(
        id: 5,
        name: 'Coffee',
        image: '${GlobalUrl}images/apps/food_delivery/category/coffee.png'));
    _categoryData.add(CategoryModel(
        id: 6,
        name: 'New Comers',
        image: '${GlobalUrl}images/apps/food_delivery/category/new.png'));
    _categoryData.add(CategoryModel(
        id: 7,
        name: 'Best Sellers',
        image: '${GlobalUrl}images/apps/food_delivery/category/best.png'));
    _categoryData.add(CategoryModel(
        id: 8,
        name: 'All Foods',
        image: '${GlobalUrl}images/apps/food_delivery/category/all.png'));
    ...
    _nearbyFoodData = [
      RestaurantModel(
          ...
          name: "Mr. Hungry",
          tag: "Chicken, Rice",
          image: "${GlobalUrl}images/apps/food_delivery/food/1.jpg",
          rating: 4.9,
          distance: 0.4,
      ...
      RestaurantModel(
          ...
          image: "${GlobalUrl}images/apps/food_delivery/food/2.jpg",
          rating: 5,
          distance: 0.6,
          promo: 'Buy 1 Get 1',
      ...
      RestaurantModel(
          ...
          image: "${GlobalUrl}images/apps/food_delivery/food/3.jpg",
          rating: 4.3,
          distance: 0.7,
          promo: '',
      ...
      RestaurantModel(
          ...
          tag: "Hot, Fresh, Steam",
          image: "${GlobalUrl}images/apps/food_delivery/food/4.jpg",
          rating: 4.9,
          distance: 0.7,
          promo: '20% Off',
      ...
      RestaurantModel(
          ...
          image: "${GlobalUrl}images/apps/food_delivery/food/5.jpg",
          rating: 4.6,
          distance: 0.9,
          promo: '',
      ...
      RestaurantModel(
          ...
          tag: "Bread",
          image: "${GlobalUrl}images/apps/food_delivery/food/6.jpg",
          rating: 4.8,
          distance: 0.9,
          promo: '',
      ...
      RestaurantModel(
          ...
          image: "${GlobalUrl}images/apps/food_delivery/food/7.jpg",
          rating: 4.9,
          distance: 1.1,
          promo: '10% Off',
      ...
      RestaurantModel(
          ...
          image: "${GlobalUrl}images/apps/food_delivery/food/8.jpg",
          rating: 4.7,
          distance: 3.9,
          promo: '10% Off',
