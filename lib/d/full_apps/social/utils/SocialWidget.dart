              ...
              text: TextSpan(
                children: [
                  TextSpan(
                      ...
                      style: TextStyle(fontSize: textSizeMedium, color: white)),
                  WidgetSpan(
                    child: Padding(
    ...
    child: Row(
      children: <Widget>[
        Container(
          ...
          child: SvgPicture.network(icon, color: social_white),
        ),
      ...
      children: <Widget>[
        ...
        GestureDetector(
          ...
          child: Container(
              ...
              child: SvgPicture.network(icon, color: social_textColorPrimary)),
        ),
      ],
    ),
  );
