                  ...
                  children: [
                    WidgetSpan(
                      child: Padding(
                        ...
                        child: SvgPicture.network(social_double_tick_indicator,
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(width: 8),
                    SvgPicture.network(social_send, color: social_icon_color),
                    SizedBox(width: 8),
                    Row(
                      children: <Widget>[
                        SvgPicture.network(social_attachment,
                            color: social_icon_color),
                        SizedBox(width: 8),
                        SvgPicture.network(social_mic_line,
                            color: social_icon_color),
                      ],
                    )
                  ],
