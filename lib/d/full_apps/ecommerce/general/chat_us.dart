...
import '../../../../models/apps/ecommerce/chat_model.dart';
...
class _ChatUsPageState extends State<ChatUsPage> {
  ...
  void _initForLang() {
    setState(() {
      ...
      _chatList.add(new ChatModel(3, 'buyer', 'image',
          '${GlobalUrl}images/apps/ecommerce/product/80.jpg', null, null));
      ...
      _chatList.add(new ChatModel(10, 'buyer', 'image',
          '${GlobalUrl}images/apps/ecommerce/product/21.jpg', null, null));
      _chatList.add(new ChatModel(
          11,
          'buyer',
          'text',
