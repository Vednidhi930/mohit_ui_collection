...
import 'package:mohit_ui_collection/d/full_apps/ecommerce/authentication/signup.dart';
          ...
          child: Row(
            ...
            children: <Widget>[
              GestureDetector(
                ...
                child: Image(
                  image: AssetImage("${GlobalUrl}images/google.png"),
                  width: 40,
                ),
              ),
              GestureDetector(
                ...
                child: Image(
                  image: AssetImage("${GlobalUrl}images/facebook.png"),
                  width: 40,
                ),
              ),
              GestureDetector(
                ...
                child: Image(
                  image: AssetImage("${GlobalUrl}images/twitter.png"),
                  width: 40,
                ),
              )
            ],
